...
{japopup type="image" content="media/gitdocs/jblesta/installupgrade_guide/assets/config-joomla-04.png" width="1024" title="Options"}
<img src="assets/config-joomla-04.png" width="100px" />{/japopup}

1. *Enable Product*<br />
Set this to 'Yes' to enable the J!Blesta product
2. *Debug*<br />
...
#### Connect your API from Joomla into Blesta

There are a number of steps to accomplish this, and they are outlined in the following guides.  Please follow them in order:

1. [Create An API User in Blesta](jblesta/howtoguides/createapiuser.md)
2. [API Connection Manager in Joomla](jblesta/howtoguides/apicnxnmgrinjoomla.md)

#### Create A Menu Item

The last step on the Joomla side is to create a menu item for J!Blesta to use.  The purpose of this menu item is two fold:
...
To access the settings for the J!Blesta on the Blesta side, follow these simple steps.
